        ...
        <section className="py-24 bg-gradient-to-br from-brand-base to-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
                    政務活動費を「使う／使わない」で悩むのではなく、<br />
                    住民に説明できる成果物として残すことで価値になります。<br />
                    <span className="font-bold text-brand-dark mt-4 block">まずは30分で、必要な範囲を整理しましょう。</span>
                </p>
                ...
                >
                    無料｜使い道設計を依頼する
                    <span className="block text-sm font-normal mt-2 opacity-90">（30分）自治体名・現状・困りごとだけでOK</span>
                </a>
